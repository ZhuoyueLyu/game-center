...
public class BoardSlidingtiles extends Board implements Serializable, Iterable<TileSlidingtiles> {
    ...
    void swapTiles(int row1, int col1, int row2, int col2) {
        TileSlidingtiles original_tile = getTile(row1, col1);
    ...
    public Iterator<TileSlidingtiles> iterator() {
        return new BoardSlidingtiles.BoardSlidingtileIterator();
    }

    private class BoardSlidingtileIterator implements Iterator<TileSlidingtiles> {
        int rowIndex = 0;
        int columnIndex = 0;
